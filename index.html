<html>
    ...
    <body style="font-family:sans-serif; font-size:20px">
        <header style="background-color:darkorange;color:black">
            <img src="https://mars.algoritmika.org/uploads/2020/10/Frame%204_0_1603385959.svg" width="50px"/ id="start">
        ...
        <main>
            ...
            <p>
            Создание игры — это всегда командная работа из нескольких этапов:
            <br>планирование сюжета, создание графических объектов, программирование, несколько этапов тестирования.
            <br>Над игрой работают программист, дизайнер, сценарист, звукорежиссёр, редактор, переводчик и многие другие специалисты.</p>
    ...
    <table style="border:1px solid green; border-collapse:collapse">
        ...
        <tr style="border:1px solid green">
            ...
            <td>Перевод: тексты,<br>
            голоса, графика</td>
            <td>от 50 тыс. руб.</td>
        </tr>
        <tr style="border:1px solid green">
            <td style="background-color: palegreen">Создание
            контента</td>
            <td>Звук, музыка,<br>
            графика 3D, 2D</td>
            <td>от 50 руб./час</td>
        ...
        <img src="https://mars.algoritmika.org/uploads/2020/10/performance-3110696_1920%201%20(3)_0_1603395974.png" widtg="1500px">
        </main>
        <footer style="background-color: darkorange; color:black">
            ...
            <p>Тел.:586-437</p>
                <form>
        <p><label>Ведение имя<input type="text"></label></p>
        <p><label>Ведение телефона<input type="tel"></label></p>
        <p><label>Ведение электронной почты<input type="email"><label></p>
        <p><label><input type="checkbox">Подключение рассылку</label></p>
